...
<html lang="en">
  ...
  <div class="row vertical-offset-100">
      ...
      <form class="form-signin" name="formone" action="medwinone.html" method="post">
  ...
  <div class="container" >
                ...
                <div class="features_op1_row">
                    ...
                    <div class="col-sm-4 feature first" style="margin-top:-900px;margin-left:350px;">
                        <div class="img_box">
                            <a href="apollo.html">
                           
                               <center><img src="medwinone.jpg" class="img-circle" width="130px" height="130px"></center>
  ...
  <div class="row vertical-offset-100">
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default" style="margin-top:-735px;margin-left:-10px;margin-right:6px;">
			  	<div class="panel-heading">
			    	<h3 class="panel-title" align="center"><b>Schedule Call Here</b></h3>
			 	</div>
			  	<div class="panel-body">
